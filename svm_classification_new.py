...
key_phrase = ["my\W*asthma", "asthma\W*attack", "i\W*have\W*asthma", "iâ€™ve\W*had\W*asthma", "have\W*asthma", "have\W*a\W*asthma",
              ...
              "asthma\W*control", "(causes|cause)\W*asthma", "my\W*inhaler", "i\W*(can not|canâ€™t)\W*breathe"]
...
def svm_classification():
    ...
    X, y = prepare_data("Indi.txt", "org.txt")
    ...
    X,y = prepare_data_test("restData1.txt")
    clf = svm.SVC(kernel='linear', C=1, class_weight={1: 2})
    scores = cross_val_score(clf, X, y, cv=10, scoring=make_scorer(f1_score))
